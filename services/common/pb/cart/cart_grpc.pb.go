...
const (
	...
	CartService_RemoveItem_FullMethodName = "/pb.CartService/RemoveItem"
...
type CartServiceClient interface {
	...
	ClearCart(ctx context.Context, in *ClearCartRequest, opts ...grpc.CallOption) (*CartEmptyResponse, error)
}
...
func (c *cartServiceClient) ClearCart(ctx context.Context, in *ClearCartRequest, opts ...grpc.CallOption) (*CartEmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CartEmptyResponse)
...
type CartServiceServer interface {
	...
	ClearCart(context.Context, *ClearCartRequest) (*CartEmptyResponse, error)
...
func (UnimplementedCartServiceServer) ClearCart(context.Context, *ClearCartRequest) (*CartEmptyResponse, error) {
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/common/pb/cart/cart.proto",
}
